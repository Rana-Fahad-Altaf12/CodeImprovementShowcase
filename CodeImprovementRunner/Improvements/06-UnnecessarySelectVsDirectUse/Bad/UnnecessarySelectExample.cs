...
{
    public class UnnecessarySelectExample : IImprovementDemo
    {
        public void Run()
        {
            Console.WriteLine("Running Bad Example (Select with anonymous type)");

            var services = new ServiceCollection();
            services.AddDbContext<AppDbContext>(options =>
                options.UseInMemoryDatabase("Bad_UnnecessarySelect"));
            ...
            var users = projectionService.GetUsersWithAnonymousProjection();
            stopwatch.Stop();
