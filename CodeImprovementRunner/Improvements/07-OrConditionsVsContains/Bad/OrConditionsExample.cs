...
{
    public class OrConditionsExample : IImprovementDemo
    {
        public void Run()
        {
            Console.WriteLine("Running Bad Example (Multiple OR conditions)");

            var services = new ServiceCollection();
            services.AddDbContext<AppDbContext>(options =>
                options.UseInMemoryDatabase("Bad_OrConditions"));
            ...
            var result = filterService.FilterUsersUsingOrConditions();
            sw.Stop();
